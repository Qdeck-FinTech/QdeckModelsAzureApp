...
class AlphaVeeWeightRebalanceSystem(IMercurySystem):
    __namespace__ = "Mercury"

    def __init__(self, cfg):
        self.name = "AlphaVeeWeightRebalanceSystem"
...
class AlphaVeeWeightRebalanceConfig(MercuryRunConfig):
    __namespace__ = "Mercury"

    def __init__(self, cfg=None):
        super().__init__()
        self.name = "AlphaVeeWeightRebalance"
...
def main(model_id=0, update_qdeck=0, live=0, config=None):
    avModelRunner = AVModelRunner(net_logger, runner_config)
